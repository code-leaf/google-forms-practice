...
const PORT = process.env.SMOKE_TEST_PORT || '4320';
...
const pages = [
  { path: '/', mustInclude: ['Google Form練習'] },
  { path: '/answerPage', mustInclude: ['Google Form練習'] },
  { path: '/formPreview', mustInclude: ['Google Form練習'] },
  { path: '/SettingPage', mustInclude: ['Google Form練習'] },
  { path: '/spreadsheet', mustInclude: ['スプレッドシート'] },
];
